        ...
        <div className="text-center max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            ...
            <button
              type="button"
              onClick={onBack}
              className="px-5 py-2.5 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition font-medium"
            >
      ...
      <section className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="p-6 sm:p-8 lg:p-10">
          ...
          <div className="flex flex-wrap gap-2 mb-5">
            ...
            {categoryName && (
              <MetadataBadge className="bg-teal-50 border-teal-100 text-teal-700">
                {categoryName}
              </MetadataBadge>
            )}
                    ...
                    (heading, index) => (
                      <a
                        ...
                        className={`block w-full text-left rounded-lg px-3 py-2 text-xs transition ${
                          heading.level === 3
                            ? "ml-3 text-slate-500 hover:text-teal-700"
                            : "font-medium text-slate-700 hover:text-teal-700"
                        }`}
                      >
                        {heading.text}
                      </a>
            ...
            <div className="article-content max-w-none">
              ...
              <ReactMarkdown
                ...
                components={{
                  ...
                  blockquote: ({ children }) => (
                    <blockquote className="border-l-4 border-teal-400 bg-teal-50 rounded-r-xl px-5 py-4 my-6 text-sm text-teal-900">
                      {children}
                    </blockquote>
                  ),
          ...
          <section className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 sm:p-8 mt-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              ...
              <div>
                ...
                <div className="text-[10px] uppercase tracking-wider font-semibold text-teal-700">
                  Knowledge quality
                </div>
            ...
            {submitted ? (
              ...
              <div className="mt-5 bg-teal-50 border border-teal-200 rounded-xl px-4 py-4">
              ...
              <div className="mt-5">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full border border-slate-300 rounded-xl px-4 py-3 text-sm mb-3 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 resize-none"
                />
                ...
                <button
                  ...
                  disabled={rating === 0}
                  className="bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium px-5 py-2.5 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Submit Feedback
                </button>
